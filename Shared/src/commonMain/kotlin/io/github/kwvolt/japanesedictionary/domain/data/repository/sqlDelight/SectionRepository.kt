...
class SectionRepository(
    ...
    override suspend fun selectRow(
        ...
        }.flatMap { result -> DatabaseResult.Success(DictionarySectionContainer(result.dictionary_entry_id, result.meaning)) }
    }
    ...
    override suspend fun deleteRow(
        ...
        return dbHandler.wrapQuery(itemId){entrySectionQueries.deleteRow(dictionaryEntrySectionId)}.map { Unit }
    }
}