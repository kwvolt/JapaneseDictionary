...
interface EntrySectionRepositoryInterface {
    ...
    suspend fun selectRow(dictionaryEntryId: Long, itemId: String? = null): DatabaseResult<DictionaryEntrySectionContainer>
     ...
     */
    suspend fun selectAllByEntryId(dictionaryEntryId: Long, itemId: String? = null): DatabaseResult<List<DictionaryEntrySectionContainer>>
