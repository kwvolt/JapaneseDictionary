...
interface EntrySectionNoteRepositoryInterface {
     ...
     * [DatabaseResult.UnknownError] if an error occurred.
     */
    suspend fun selectRow(id: Long, itemId: String? = null): DatabaseResult<DictionaryEntrySectionNoteContainer>
     ...
     * [DatabaseResult.UnknownError] if an error occurred.
     */
    suspend fun selectAllBySectionId(dictionaryEntrySectionId: Long, itemId: String? = null): DatabaseResult<List<DictionaryEntrySectionNoteContainer>>
