...
interface WordClassRepositoryInterface {
    suspend fun insertByMainClassIdAndSubClassId(
        mainClassId: Long,
        subClassId: Long,
        itemId: String? = null,
    ...
    suspend fun insertByMainClassIdNameAndSubClassIdName(
    ...
    suspend fun selectIdByMainClassIdAndSubClassId(
        mainClassId: Long,
        subClassId: Long,
        itemId: String? = null,
        returnNotFoundOnNull: Boolean = false
    ...
    suspend fun selectIdByMainClassIdNameAndSubClassIdName(
        mainClassIdName: String,
        subClassIdName: String,
        itemId: String? = null,
        returnNotFoundOnNull: Boolean = false
    ...
    suspend fun selectRow(
        wordClassId: Long,
        itemId: String? = null,
        returnNotFoundOnNull: Boolean = false
    ): DatabaseResult<WordClassIdContainer>

    suspend fun updateMainClassId(
        wordClassId: Long,
        mainClassId: Long,
        itemId: String? = null,
        returnNotFoundOnNull: Boolean = false
    ...
    suspend fun updateMainClassIdAndSubClassId(
        wordClassId: Long,
        mainClassId: Long,
        subClassId: Long,
        itemId: String? = null,
    ...
    suspend fun deleteRowByWordClassId(
        wordClassId: Long,
        itemId: String? = null,
        returnNotFoundOnNull: Boolean = false
    ):DatabaseResult<Unit>

    suspend fun deleteRowByMainClassIdAndSubClassId(
        mainClassId: Long,
        subClassId: Long,
        itemId: String? = null,
        returnNotFoundOnNull: Boolean = false
